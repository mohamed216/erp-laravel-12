...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .sidebar-custom { display: none; position: fixed; z-index: 1000; width: 70%; top: 0; height: 100%; }
...
<body>
    ...
    <nav class="navbar navbar-custom">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/dashboard"><img src="/images/logo.svg" height="30" class="me-2">ERP System</a>
